...
contract Curve3PoolBridge is IDefiBridge {
        ...
        )
    {
        ...
        if (inputAssetA.erc20Address == MIM_0) {
            i = 0;
        } else if (inputAssetA.erc20Address == DAI_1) {
            i = 1;
        } else if (inputAssetA.erc20Address == USDC_2) {
            i = 2;
        } else if (inputAssetA.erc20Address == TETHER_3) {
            i = 3;
        } else {
            revert("Curve3PoolBridge: INCOMPATIBLE_ASSET_PAIR");
        }

        if (outputAssetA.erc20Address == MIM_0) {
            j = 0;
        } else if (outputAssetA.erc20Address == DAI_1) {
            j = 1;
        ...
        curvePool.exchange_underlying(i, j, inputValue, 1);
    }
